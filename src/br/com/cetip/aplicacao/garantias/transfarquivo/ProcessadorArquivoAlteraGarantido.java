 ...
 * @author brunob
 */
public class ProcessadorArquivoAlteraGarantido extends ProcessadorArquivoBloco {
   ...
   public void validarBloco(List linhasBloco, List atributosTitulo, Servicos servicos) {
      ...
      RequisicaoServicoValidaAlteracaoCestaGarantias req = new RequisicaoServicoValidaAlteracaoCestaGarantias();
      req.atribuirGARANTIAS_CODIGO_NumeroCestaGarantia((NumeroCestaGarantia) atributosTitulo.get(3));
      req.atribuirGARANTIAS_CONTRAPARTE_CodigoContaCetip((CodigoContaCetip) atributosTitulo.get(4));
   ...
   public Requisicao obterRequisicao(List atributos) {
      Requisicao r = null;
      r = new RequisicaoServicoAlteraCestaGarantias();
      return r;
   }
   ...
   public Requisicao montarRequisicaoBloco(Requisicao req, List linhasBloco, List atributosTitulo, Servicos servicos) {
      RequisicaoServicoAlteraCestaGarantias requisicao = (RequisicaoServicoAlteraCestaGarantias) req;
      requisicao.atribuirGARANTIAS_CODIGO_NumeroCestaGarantia((NumeroCestaGarantia) atributosTitulo.get(3));
      requisicao.atribuirGARANTIAS_CONTRAPARTE_CodigoContaCetip((CodigoContaCetip) atributosTitulo.get(4));
      return requisicao;
   }
   ...
   public Campo[] obterCamposTitulo() {
      ...
      if (versao.obterConteudo().equals("00001")) {
         return new Campo[] { new CampoPosicional(5, new DescricaoLimitada(Contexto.GARANTIAS_CODIGO), true), // 00
               ...
               new CampoPosicional(8, new CodigoContaCetip(Contexto.GARANTIAS_CONTRAPARTE), true), // 04
         };
      }
