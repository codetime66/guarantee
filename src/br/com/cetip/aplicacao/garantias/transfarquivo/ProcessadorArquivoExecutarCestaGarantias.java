...
/**
 * Processador de arquivo para LIBERACAO de Cestas de Garantias
 * 
 * @author <a href="mailto:bruno.borges@summa-tech.com">Bruno Borges</a>
 */
public class ProcessadorArquivoExecutarCestaGarantias extends ProcessadorArquivoBloco {
   ...
   public Requisicao obterRequisicao(List atributos) {
      return new RequisicaoServicoExecutarCestaGarantias();
   }
   ...
   public Requisicao montarRequisicaoBloco(Requisicao req, List linhasBloco, List atributosTitulo, Servicos servicos) {
      ...
      requisicao.atribuirGARANTIAS_PARTICIPANTE_CodigoContaCetip((CodigoContaCetip) atributosTitulo.get(4));
      return requisicao;
   }
   ...
   public Campo[] obterCamposTitulo() {
      ...
      if (versao.obterConteudo().equals("00001")) {
         return new Campo[] { new CampoPosicional(5, new DescricaoLimitada(Contexto.GARANTIAS_CODIGO), false), // 00
               ...
               new CampoPosicional(14, new CodigoContaCetip(Contexto.GARANTIAS_PARTICIPANTE), false), // 04
               new CampoPosicional(14, new CodigoContaCetip(Contexto.GARANTIAS_CONTRAPARTE), false), // 05
         };
      }
