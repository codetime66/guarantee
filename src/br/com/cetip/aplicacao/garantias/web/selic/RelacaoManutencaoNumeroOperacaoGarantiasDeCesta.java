...
import br.com.cetip.aplicacao.garantias.servico.selic.RequisicaoServicoListaGarantiasCestaParaManutencaoNumOp;
import br.com.cetip.aplicacao.garantias.web.ConfirmacaoRelacaoCestasGarantias;
...
/**
 * Relacao para manutencao de numero de operacao de ativos selicados de Garantias da Cesta
 * 
 */
public class RelacaoManutencaoNumeroOperacaoGarantiasDeCesta extends Relacao {
   ...
   public RelacaoManutencaoNumeroOperacaoGarantiasDeCesta() {
      Logger.info("RelacaoManutencaoNumeroOperacaoGarantiasDeCesta - init!");
   }
    ...
    * 
    * @see
    * br.com.cetip.base.web.acao.Relacao#informarColunas(br.com.cetip.base.web.layout.
    * manager.grupo.GrupoDeAtributos, br.com.cetip.base.web.layout.manager.grupo.Grupo,
    ...
    * 
    * @see
    * br.com.cetip.base.web.acao.Relacao#chamarServico(br.com.cetip.base.web.layout.manager
    * .grupo.Grupo, br.com.cetip.base.web.acao.suporte.Servicos)
    */
   public GrupoDeAtributos chamarServico(Grupo dados, Servicos servicos) throws Exception {
      ...
      RequisicaoServicoListaGarantiasCestaParaManutencaoNumOp req = new RequisicaoServicoListaGarantiasCestaParaManutencaoNumOp();
    ...
    * 
    * @see
    * br.com.cetip.base.web.acao.Relacao#informarParametros(br.com.cetip.base.web.layout
    * .manager.grupo.GrupoDeAtributos, br.com.cetip.base.web.layout.manager.grupo.Grupo,
    * br.com.cetip.base.web.acao.suporte.Servicos)
    */
   public void informarParametros(GrupoDeAtributos parametros, Grupo dados, Servicos servicos) throws Exception {
      ...
      parametros.atributo(new Quantidade(Contexto.GARANTIAS_QUANTIDADE));
    ...
    * 
    * @see
    * br.com.cetip.base.web.acao.Relacao#obterDestino(br.com.cetip.infra.atributo.Atributo
    * , br.com.cetip.base.web.layout.manager.grupo.Grupo,
    * br.com.cetip.base.web.acao.suporte.Servicos)
    */
   public Class obterDestino(Atributo atributo, Grupo parametros, Servicos servicos) throws Exception {
      ...
      Quantidade qtd = (Quantidade) parametros.obterAtributo(Quantidade.class, Contexto.GARANTIAS_QUANTIDADE);
      ...
      while (iLinhas.hasNext()) {
         ...
         qtd = (Quantidade) parametros.obterAtributoSeguinte(Quantidade.class, Contexto.GARANTIAS_QUANTIDADE);
      ...
      // VALIDA
      new ConfirmacaoRelacaoManutencaoNuOpGarantiasDeCesta().validar(parametros, servicos);

      return ConfirmacaoRelacaoManutencaoNuOpGarantiasDeCesta.class;
   }
    ...
    * 
    * @see
    * br.com.cetip.base.web.acao.Relacao#informarLinks(br.com.cetip.base.web.acao.suporte
    * .Links, br.com.cetip.base.web.layout.manager.grupo.Grupo,
    * br.com.cetip.base.web.acao.suporte.Servicos)
    */
