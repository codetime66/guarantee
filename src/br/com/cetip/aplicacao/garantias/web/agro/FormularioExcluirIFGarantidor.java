 ...
 * @since Maio/20010
 */
public class FormularioExcluirIFGarantidor extends AbstractFormularioGarantias {
   ...
   public void validar(Grupo dados, Servicos servicos) throws Exception {
      ...
      req.atribuirACAO_NumeroInteiro( Parametros.EXCLUIR );
   ...
   public Notificacao chamarServico(Grupo dados, Servicos servicos) throws Exception {
      ...
      String notificacao = "FormularioExcluirIFGarantidor.Sucesso";
