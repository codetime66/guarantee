 ...
 * @resultado.class
 */
public class ServicoValidaConsultaAtivosGarantia implements Servico {
	...
	public Resultado executarConsulta(Requisicao requisicao) throws Exception {
		RequisicaoServicoValidaConsultaAtivosGarantia req = (RequisicaoServicoValidaConsultaAtivosGarantia) requisicao;
		ResultadoServicoValidaConsultaAtivosGarantia res = new ResultadoServicoValidaConsultaAtivosGarantia();

		NomeSimplificado nomeGarantidor = req.obterNOME_SIMPLIFICADO_GARANTIDO_NomeSimplificado();

		NomeRegra predicado = ConstantesDeNomeDeRegras.validaConsultaAtivosGarantia;
		...
		if (Logger.estaHabilitadoDebug(this)) {
			Logger.debug(this, "### ServicoValidaConsultaAtivosGarantia : AtributosColunados (termos) : ");
